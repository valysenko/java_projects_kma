package courseraclasses;

import java.awt.Color;

import practice14_SEAMCARVING.SeamCarving;
...
public class SCUtility {
    ...
    public static double[][] toEnergyMatrix(SeamCarving  sc)
    {
    ...
    public static void showEnergy(SeamCarving sc)
    {
        doubleToPicture(toEnergyMatrix(sc)).show();
    }

    public static Picture toEnergyPicture(SeamCarving sc)
    {
